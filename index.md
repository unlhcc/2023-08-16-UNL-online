...
latitude: "40.820"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "-96.706"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "Aug 16-17, 2023"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
startdate: 2023-08-16      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2023-08-17       # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Mohammed Tanash","Caughlin Bohn", "Chia Sin Liew" ] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Natasha Pavlovikj", "Tom Harvill", "Hanying Chen"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
<center><form><button name="button" style="background-color: D71920; padding: 15px 32px" formaction="https://marketplace.unl.edu/hcc/hcc-software-carpentry-workshop-august-2023.html">Registration now closed!</button></form></center>
